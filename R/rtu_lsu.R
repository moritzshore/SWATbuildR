#' Build SWAT+ routing unit input files.
#'
#' In the current configuration of SWATbuildR setups one routing unit only
#' contains one HRU. Hence, the routing unit inputs are generated from the hru
#' input tables.
#'
#' @returns The function writes the following tables into the intermediate data
#'   base:
#'   - rtu.rout_unit_con
#'   - rtu.rout_unit_ele
#'   - rtu.rout_unit_rtu
...
#' Build SWAT+ routing unit con_out based on the connect_ids table.
#'
#' This already adds the connection to the single aquifer that will be added to
#' the setup in a next step.
#'
#' @param data_path Path of the project data folder
#'
#' @importFrom DBI dbConnect dbDisconnect dbReadTable dbWriteTable
