#' Identify infinite loops in the object connections.
#'
...
#' connection chain.
#'
#' This is used to remove connection duplicates and reduce the number of
...
#' Resolve infinite loops that occur in the routing between land objects.
#'
...
#' @importFrom RSQLite SQLite
#' @importFrom sf read_sf st_area write_sf
