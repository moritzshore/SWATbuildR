#' Save DEM and slope raster layers
#'
...
save_dem_slope_raster <- function(dem, data_path) {
  ...
  slp_rad <- terrain(dem_basin, v="slope", neighbors=8, unit="radians")
...
#' Prepare and save the soil raster layer in the project data/raster folder.
#'
...
#' @importFrom terra extract rast vect zonal
#'
#' @returns Writes the tabble hru_terrain_soil into the data base tables.sqlite.
#'
#' @export
#'
...
#' @param data_path Path of the project data folder
#'
#' @returns The function writes 4 tables into tables.sqlite:
